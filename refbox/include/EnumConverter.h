/**
 *  This header file defines the EnumConverter class. It is highly recommended
 *  whenever an enum converter class is created, to enhance this one.
 *
 *  Version: 1.0.0
 *  Created on: 08/10/2016
 *  Modified on: 08/10/2016
 *  Author: Adriano Henrique Rossette Leite (adrianohrl@unifei.edu.br)
 *  Maintainer: Expertinos UNIFEI (expertinos.unifei@gmail.com)
 */

#ifndef _ENUM_CONVERTER_H_
#define _ENUM_CONVERTER_H_
